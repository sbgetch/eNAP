...
const hplFas = [
  ...
  },
  {
    ...
    content:
      '[div] The Loopback fault should disappear when the loop is forced to exist using a\n            jumper wire or a DMM in ammeter mode. The CAN0 error will appear after a delay when a\n            connector is unplugged. This error can be ignored. [/div] [div] If the Loopback fault\n            does not go away when each step is executed and the probes were verified to be on the\n            right pins, then the component above the probes (PCA or battery shelf) is suspected to\n            be faulty. [/div] [div] Battery shelf being faulty could mean that the wire harness is\n            faulty or an MBB (board in battery) is faulty. If PCA is faulty, it means the BMS board\n            700712G1 is faulty since this is the only thing in the PCA that touches the loop. [/div]\n            [ol] [li]Check PCA by probing BATT header pins 5 & 6 with jumper wire or DMM in\n            ammeter\n            mode.[/li] [li]Check battery shelf 6 by probing wire-to-wire connector pins 5 & 6\n            with\n            jumper wire or DMM in ammeter mode.[/li] [li]Check battery shelf 5 by probing\n            wire-to-wire connector pins 5 & 6 with jumper wire or DMM in ammeter mode.[/li]\n            [li]Check battery shelf 4 by probing wire-to-wire connector pins 5 & 6 with jumper\n            wire\n            or DMM in ammeter mode.[/li] [li]Check battery shelf 3 by probing wire-to-wire connector\n            pins 5 & 6 with jumper wire or DMM in ammeter mode.[/li] [li]Check battery shelf 2\n            by\n            probing wire-to-wire connector pins 5 & 6 with jumper wire or DMM in ammeter\n            mode.[/li]\n            [/ol] [div class="quick-box"] [div class="label"]Illustrations:[/div] [div\n            class="icon-index"] [div][a href="graphic/b3452201.png" class="ref-popup"\n            target="_blank"]Battery Monitoring and Balance Boards (MBB)[/a][/div] [div][a\n            href="graphic/b3452202.png" class="ref-popup" target="_blank"]BATT Header on PCA -\n            Looking at PCA[/a][/div] [div][a href="graphic/b3452203.png" class="ref-popup"\n            target="_blank"]Probing BATT Header Pins with Jumper Wire[/a][/div] [div][a\n            href="graphic/b3452204.png" class="ref-popup" target="_blank"]Probing Wire-to-Wire\n            Connector Pins with Jumper Wire[/a][/div] [div][a href="graphic/b3452205.png"\n            class="ref-popup" target="_blank"]Plug Illustrations[/a][/div] [div][a\n            href="graphic/b3452206.png" class="ref-popup" target="_blank"]RCPT\n            Illustrations[/a][/div] [div][a href="graphic/b3452207.png" class="ref-popup"\n            target="_blank"]Wire Harness 565119 (Inter-Module Wire Harness Layout)[/a][/div] [/div]\n            [/div]',
    type: "warning",
  },
  {
    title: "Low Battery",
