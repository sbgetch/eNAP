...
if (Array.isArray(partsResearchToolData_5) && partsResearchToolData_5[0]) {
  partsResearchToolData_5[0].segments = {
    ...(partsResearchToolData_5[0].segments || {}),
    ...powerProductsExtraSegments,
  };
}
...
const partsResearchToolData = [
  ...
  ...(Array.isArray(partsResearchToolData_6) ? partsResearchToolData_6 : []), //prt-data-7
];
...
function fSelectorType_Create(oFilteredParts) {
  ...
  function createTypeOption({ text, value, id = null }) {
    const inputId = id ?? `type-selector-${value}`;
